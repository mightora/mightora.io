...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Tweed Technology Ltd, Clavering House.
...
- **Website** refers to Tweed Technology Ltd, accessible from [https://tweed.technology](https://tweed.technology/)
...
## Rapid API and our APIs

We host a number of APIs through [Rapid API](https://rapidapi.com/orghomepage/mightora), the customers of these APIs are managed through the API market place platform provided by [Rapid API](https://rapidapi.com/orghomepage/mightora). For further information on [Rapid APIs Privacy Policy](https://rapidapi.com/privacy/) please visit [https://rapidapi.com/privacy/](https://rapidapi.com/privacy/)
